...
INSERT INTO Client 
VALUES
(1, 'Brent', 'Plage', 'Plage@gmail.com', 'plagemaster', '0866598745'),
(2, 'Claude', 'Pretorius', 'ClaudeP@gmail.com', 'pretoriusmaster', '0866598745')
GO
...
values
(1,2,'Wedding','2021/12/17', '13:30', '56 Platberg Avenue, Kempton Park, Gauteng', 10, 5, 8, 4, 15, 15,'Deposit', 253,506, 'N/a', 0),
(2,1,'Barbeque','2021/12/18', '11:25', '84 Johnson Avenue, Boksburg, Gauteng', 11, 9, 11, 9, 20, 20 ,'Yes', 0, 600, 'Yes- 50 blue balloons on the front gate and 10 surprise wrappers per meal with a toy in', 50)
GO
